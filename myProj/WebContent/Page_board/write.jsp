...
<link rel="stylesheet" href="../css/t_input.css" type="text/css">
	...
	<script type="text/javascript">
		...
		function checkValue()
		{
			if(!document.boardInfo.passwd.value){
				alert("비밀번호를 입력하세요.");
				return false;
			}
			
			if(!document.boardInfo.subject.value){
				alert("제목을 입력하세요.");
				return false;
			}
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8">
					<div class="contact__form">
                        <form action="writePro.jsp" name="boardInfo" enctype="multipart/form-data" method="post" onsubmit="return checkValue()">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <textarea name="content" placeholder="Content" class="input_black" >
- 인원수 : 
- 예약일 : 
- 예약시간 : </textarea>
